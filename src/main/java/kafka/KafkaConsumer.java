...
public class KafkaConsumer {
	...
	public void testMultiThreadConsumer(int threadCount) {
		...
		// Here we have used a single topic but we can also add multiple topics
		// to topicCount MAP
	...
	public static void main(String[] args) {
		String zooKeeper = "192.168.136.128:2181";
		String groupId = "test";
		String topic = "test";
		int threadCount = Integer.parseInt("1");
		KafkaConsumer multiThreadHLConsumer = new KafkaConsumer(zooKeeper, groupId, topic);
